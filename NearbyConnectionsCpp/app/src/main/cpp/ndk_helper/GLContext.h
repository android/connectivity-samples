...
// GLContext.h
//-----------------------------------------------------------------------------
#ifndef _USR_LOCAL_GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_GLCONTEXT_H_
#define _USR_LOCAL_GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_GLCONTEXT_H_
...
class GLContext {
 ...
 public:
   ...
   * which is usually 59.94hz. In API 17 (JellyBeans)~, the API accepts value
   * of 0, which does not sync to vblank.
   */
...
#endif  // _USR_LOCAL_GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_GLCONTEXT_H_
