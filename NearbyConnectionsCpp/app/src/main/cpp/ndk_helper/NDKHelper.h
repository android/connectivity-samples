 ...
 */
#ifndef _GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_NDKHELPER_H_
#define _GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_NDKHELPER_H_
...
#endif  // GOOGLE_SAMPLES_ANDROID_NEARBYCONNECTIONS_JNI_NDK_HELPER_NDKHELPER_H_
