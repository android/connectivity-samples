 ...
 */
class DiscoveryTwoPlayerActivity : AppCompatActivity(R.layout.activity_two_player) {
    ...
    gameManager.sendGameChoice(
      ...
      object : GameManager.Callback() {
        override fun onFailure() {
          Toast.makeText(this@DiscoveryTwoPlayerActivity, R.string.send_failure, Toast.LENGTH_SHORT)
            .show()
        }
      }
    )
  ...
  companion object {
    private const val TAG = "DiscoveryTwoPlayerActivity"
  }
}
